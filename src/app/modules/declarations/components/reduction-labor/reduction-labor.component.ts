...
@Component({
  selector: 'app-declaration-reduction-labor',
  templateUrl: './reduction-labor.component.html',
  styleUrls: [ './reduction-labor.component.less' ]
})
export class ReducingLaborComponent implements OnInit, OnDestroy {

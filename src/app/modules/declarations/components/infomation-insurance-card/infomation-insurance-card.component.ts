...
@Component({
  selector: 'app-infomation-insurance-card',
  templateUrl: './infomation-insurance-card.component.html',
  styleUrls: [ './infomation-insurance-card.component.less' ]
})
export class InfomationInsuranceCardComponent implements OnInit, OnDestroy {

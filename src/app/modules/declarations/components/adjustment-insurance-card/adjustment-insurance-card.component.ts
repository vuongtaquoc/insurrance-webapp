...
import { TABLE_NESTED_HEADERS, TABLE_HEADER_COLUMNS } from '@app/modules/declarations/data/adjustment-insurance-card.data';
...
@Component({
  selector: 'app-declaration-adjustment-insurance-card',
  templateUrl: './adjustment-insurance-card.component.html',
  styleUrls: [ './adjustment-insurance-card.component.less' ]
})
export class AdjustmentInsuranceCardComponent implements OnInit, OnDestroy {

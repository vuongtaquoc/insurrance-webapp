...
@Component({
  selector: 'app-maternity-approval',
  templateUrl: './maternity-approval.component.html',
  styleUrls: ['./maternity-approval.component.less']
})
export class MaternityApprovalComponent implements OnInit, OnDestroy {

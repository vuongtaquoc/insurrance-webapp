...
@Component({
  selector: 'app-return-payment-list',
  templateUrl: './return-payment-list.component.html',
  styleUrls: ['./return-payment-list.component.less', '../reduction-labor-list/reduction-labor-list.component.less']
})
export class ReturnPaymentListComponent implements OnInit {

...
@Component({
  selector: 'app-register-insurance-required-edit',
  templateUrl: './register-insurance-required-edit.component.html',
  styleUrls: ['./register-insurance-required-edit.component.less']
})
export class RegisterInsuranceRequiredEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/register-insurance-required']);
    }
  }

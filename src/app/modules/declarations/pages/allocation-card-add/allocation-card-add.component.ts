...
@Component({
  selector: 'app-declaration-allocation-card-add',
  templateUrl: './allocation-card-add.component.html',
  styleUrls: ['./allocation-card-add.component.less']
})
export class AllocationCardAddComponent extends PageCoreComponent {
  handlers: any[] = [];
  isSpinning = false;
  constructor(

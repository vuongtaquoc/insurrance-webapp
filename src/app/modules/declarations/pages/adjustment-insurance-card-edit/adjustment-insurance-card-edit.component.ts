...
@Component({
  selector: 'app-adjustment-insurance-card-edit',
  templateUrl: './adjustment-insurance-card-edit.component.html',
  styleUrls: ['./adjustment-insurance-card-edit.component.less']
})
export class AdjustmentInsuranceCardEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/adjustment-insurance-card']);
    }
  }

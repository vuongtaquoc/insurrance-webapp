...
@Component({
  selector: 'app-return-payment-organization-list',
  templateUrl: './return-payment-organization-list.component.html',
  styleUrls: ['./return-payment-organization-list.component.less', '../reduction-labor-list/reduction-labor-list.component.less']
})
export class ReturnPaymentOrganizationListComponent implements OnInit {

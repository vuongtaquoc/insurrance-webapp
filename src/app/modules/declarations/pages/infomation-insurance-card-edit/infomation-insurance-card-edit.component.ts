...
@Component({
  selector: 'app-infomation-insurance-card-edit',
  templateUrl: './infomation-insurance-card-edit.component.html',
  styleUrls: ['./infomation-insurance-card-edit.component.less']
})
export class InfomationInsuranceCardEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/infomation-insurance-card']);
    }
  }

...
@Component({
  selector: 'app-reissue-insurance-expire-edit',
  templateUrl: './reissue-insurance-expire-edit.component.html',
  styleUrls: ['./reissue-insurance-expire-edit.component.less']
})
export class ReissueInsuranceExpireEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/reissue-insurance-expire']);
    }
  }

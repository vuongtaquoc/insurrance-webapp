...
@Component({
  selector: 'app-return-payment-edit',
  templateUrl: './return-payment-edit.component.html',
  styleUrls: ['./return-payment-edit.component.less']
})
export class ReturnPaymentEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/return-payment']);
    }
  }

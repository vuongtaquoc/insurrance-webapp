...
@Component({
  selector: 'app-infomation-insurance-card-add',
  templateUrl: './infomation-insurance-card-add.component.html',
  styleUrls: ['./infomation-insurance-card-add.component.less']
})
export class InfomationInsuranceCardAddComponent extends PageCoreComponent {
  handlers: any[] = [];

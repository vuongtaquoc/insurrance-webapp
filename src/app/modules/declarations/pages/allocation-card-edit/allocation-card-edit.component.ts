...
@Component({
  selector: 'app-declaration-allocation-card-edit',
  templateUrl: './allocation-card-edit.component.html',
  styleUrls: ['./allocation-card-edit.component.less']
})
export class AllocationCardEditComponent extends PageCoreComponent implements OnInit {
  ...
  handleSubmit(data) {
    if (data.type === 'saveAndView') {
      ...
      this.router.navigate(['/declarations/allocation-card']);
    }
  }

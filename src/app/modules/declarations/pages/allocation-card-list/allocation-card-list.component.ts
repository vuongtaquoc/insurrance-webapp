...
@Component({
  selector: 'app-declaration-allocation-card-list',
  templateUrl: './allocation-card-list.component.html',
  styleUrls: ['./allocation-card-list.component.less','../reduction-labor-list/reduction-labor-list.component.less']
})
export class AllocationCardListComponent implements OnInit {

...
@Component({
  selector: 'app-register-insurance-required-add',
  templateUrl: './register-insurance-required-add.component.html',
  styleUrls: ['./register-insurance-required-add.component.less']
})
export class RegisterInsuranceRequiredAddComponent extends PageCoreComponent {
  handlers: any[] = [];

...
@Component({
  selector: 'app-register-insurance-required-list',
  templateUrl: './register-insurance-required-list.component.html',
  styleUrls: ['./register-insurance-required-list.component.less', '../reduction-labor-list/reduction-labor-list.component.less']
})
export class RegisterInsuranceRequiredListComponent implements OnInit {

...
@Component({
  selector: 'app-adjustment-insurance-card-list',
  templateUrl: './adjustment-insurance-card-list.component.html',
  styleUrls: ['./adjustment-insurance-card-list.component.less', '../reduction-labor-list/reduction-labor-list.component.less']
})
export class AdjustmentInsuranceCardListComponent implements OnInit {

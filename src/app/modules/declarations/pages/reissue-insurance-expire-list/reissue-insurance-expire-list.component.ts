...
@Component({
  selector: 'app-reissue-insurance-expire-list',
  templateUrl: './reissue-insurance-expire-list.component.html',
  styleUrls: ['./reissue-insurance-expire-list.component.less', '../reduction-labor-list/reduction-labor-list.component.less']
})
export class ReissueInsuranceExpireListComponent implements OnInit {

...
@Component({
  selector: 'app-adjustment-insurance-card-add',
  templateUrl: './adjustment-insurance-card-add.component.html',
  styleUrls: ['./adjustment-insurance-card-add.component.less']
})
export class AdjustmentInsuranceCardAddComponent extends PageCoreComponent {
  handlers: any[] = [];
